# Contributing to ssh-knock-interceptor
...
In short, when you submit code changes, your submissions are understood to be under the same [MIT](https://github.com/timo-reymann/ssh-knock-interceptor/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
